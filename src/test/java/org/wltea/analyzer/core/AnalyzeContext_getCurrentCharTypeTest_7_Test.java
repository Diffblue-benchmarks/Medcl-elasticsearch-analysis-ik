...
public class AnalyzeContext_getCurrentCharTypeTest_7_Test {
  @Test
  public void getCurrentCharTypeTest() throws Exception {
    // Arrange
    AnalyzeContext analyzeContext = new AnalyzeContext(null);

    // Act
    int actual = analyzeContext.getCurrentCharType();
