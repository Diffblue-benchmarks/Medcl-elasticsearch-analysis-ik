...
public class Lexeme_getLexemeTypeStringTest_12_Test {
  @Test
  public void getLexemeTypeStringTest() throws Exception {
    // Arrange
    Lexeme lexeme = new Lexeme(1, 1, 1, 1);

    // Act
    String actual = lexeme.getLexemeTypeString();

    // Assert
    Assert.assertEquals("ENGLISH", actual);
