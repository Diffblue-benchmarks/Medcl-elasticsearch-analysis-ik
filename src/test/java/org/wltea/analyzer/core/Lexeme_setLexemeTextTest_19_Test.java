...
public class Lexeme_setLexemeTextTest_19_Test {
  @Test
  public void setLexemeTextTest() throws Exception {
    // Arrange
    Lexeme lexeme = new Lexeme(1, 1, 1, 1);
    String lexemeText = "aaaaa";
    ...
    Assert.assertEquals("aaaaa", lexeme.getLexemeText());
    Assert.assertEquals(5, length);
    Assert.assertEquals(7, endPosition);
    ...
    Assert.assertEquals("2-7 : aaaaa : \tENGLISH", toStringResult);
  }
  @org.junit.Rule
