...
public class AnalyzeContext_AnalyzeContextTest_12_Test {
  @Test
  public void AnalyzeContextTest() throws Exception {
    // Arrange
    Configuration configuration = (Configuration) null;

    // Act
    AnalyzeContext analyzeContext = new AnalyzeContext(configuration);
