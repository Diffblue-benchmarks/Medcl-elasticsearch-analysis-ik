...
public class IkTokenizerFactory_getIkTokenizerFactoryTest_3_Test {
  @Test
  public void getIkTokenizerFactoryTest() throws Exception {
    // Arrange
    ...
    IkTokenizerFactory.getIkTokenizerFactory(indexSettings, environment, name, settings);
