...
public class IkTokenizerFactory_IkTokenizerFactoryTest_1_Test {
  @Test
  public void IkTokenizerFactoryTest() throws Exception {
    // Arrange
    ...
    new IkTokenizerFactory(indexSettings, environment, name, settings);
